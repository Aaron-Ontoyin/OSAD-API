...
text_audio_processing.get("/audio-text")(get_audio_text)
text_audio_processing.get("/audios-texts")(get_all_audio_texts)
text_audio_processing.delete("/audio-text")(delete_audio_text)
